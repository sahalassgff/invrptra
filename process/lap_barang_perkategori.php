...
<head>
    ...
    <title>Cetak Laporan Barang Masuk Per Kategori</title>
</head>

<body>
    <?php
    $kategori_id = $_POST['kategori_id']; // Kategori yang dipilih
    ...
    // Ambil nama kategori untuk header laporan
    $kategori_query = mysqli_query($con, "SELECT nama_kategori FROM kategori WHERE idkategori = '$kategori_id'");
    $kategori = mysqli_fetch_assoc($kategori_query)['nama_kategori'];
    ?>
    <div style="page-break-after:always;text-align:center;margin-top:5%;">
        <div style="line-height:5px;">
            <h2>LAPORAN BARANG MASUK PER KATEGORI</h2>
