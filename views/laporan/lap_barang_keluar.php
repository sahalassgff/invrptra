...
<div class="container-fluid" id="laporan-page">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Cetak Laporan Barang Keluar Per Kategori Barang</h1>
        </div>

        <div class="card shadow mb-4">
        <div class="card-body">
            <!-- Form untuk memilih kategori dan mencetak laporan -->
            <form action="<?= base_url(); ?>process/cetak_barang_keluar_perkategori.php" method="post" target="_blank">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Laporan Barang Keluar Seluruh</h1>
        </div>
